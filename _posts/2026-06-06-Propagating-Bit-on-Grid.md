...
Here is [the lecture](https://www.youtube.com/watch?v=P7-Xtkra2s4) that introduced the problem to me, as well as [the paper](https://people.lids.mit.edu/yp/homepage/data/2020_2dgrid.pdf) proving the impossibility of a set of functions in 2D.
